...
main(void)
{
  ...
  avro_schema_record_field_append(sc_type_record, "sc_rcrd_field_name1", sc_type_map);
  avro_schema_record_field_append(sc_type_record, "sc_rcrd_field_name2", sc_type_map);
  ...
  avro_value_get_by_name(&v_type_record, "sc_rcrd_field_name", &v_type_map, NULL);
  ...
  avro_value_get_by_name(&v_type_record, "sc_rcrd_field_name1", &v_type_map, NULL);
  ...
  avro_value_get_by_name(&v_type_record, "sc_rcrd_field_name2", &v_type_map, NULL);
